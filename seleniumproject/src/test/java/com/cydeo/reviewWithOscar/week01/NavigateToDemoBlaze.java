...
public class NavigateToDemoBlaze {
    public static void main(String[] args) {
        ...
        String expectedTitle = "STORE"; //comes from documentation, SRS: system requirement specification
        // we have getTitle() method in Selenium WebDriver library
        String actualTitle = driver.getTitle();

        //As a tester, without verification what is you VALUE to the Company
