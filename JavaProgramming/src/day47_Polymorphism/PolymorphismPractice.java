...
public class PolymorphismPractice {
    public static void main(String[] args) {
        ...
        Car[] cars = {
                new Toyota("Highlander", "red", 25000, 2010, 255000),
                new BMW("X5", "red", 32000, 2010, 12000),
                new Toyota("Corolla", "blue", 20000, 2010, 310000),
                new BMW("M3", "Blue", 33000, 2019, 14030),
                new BMW("M5", "Black", 35000, 2018, 15000),
                new BMW("M4", "White", 40000, 2017, 19000),
                new BMW("7 Series","Purple" , 30000, 2017, 21000),
                new BMW("i3", "Black", 30000, 2017, 9000),
                new Toyota("Camry", "Red", 30000, 2018, 185000),
                new Toyota("Rav4", "Red", 23000, 2012, 285000),
                new Toyota("Avalon", "Blue", 35000, 2019, 175230),
                new Tesla("Model 3", "Black", 45000, 2018, 235000),
                new Tesla("Model Y", "Black", 65000, 2012, 135000),
                new Tesla("Model X", "White", 48000, 2018, 235000),
                new Tesla("Model X", "White", 48000, 2017, 236000),
        };
